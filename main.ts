...
let personName: string = "kristina";
...
let members: string[] = ["sana", "javeriya", "jessica", "andrew", "aman"];
...
let member: string[] = ["sana", "javeriya", "jessica", "andrew", "aman"];
let messages: string = `Please eat your lunch  `;
for (let i = 0; i < members.length; i++) {
...
let guestList: string[] = ["AMAN", "ASHWARYA", "JESSICA", "JASON"];
...
let guest_list: string[] = ["AMAN", "ASHWARYA", "JESSICA", "JASON"];
...
let not_coming: string = "ASHWARYA";
let new_guest: string = "VIKRAM";
...
let GuestList: String[] = ["AMAN", "ASHWARYA", "JESSICA", "JASON"];
let NotComing: string = "ASHWARYA";
let NewGuest: string = "vikram";
...
while (GUESTLIST.length > 2) {
  ...
  console.log(
    `Sorry Sir/Madam :${remove_guest} you ae not invited for dinner.`
  );
}
for (let i = 0; i < GUESTLIST.length; i++) {
  console.log(
...
let places: string[] = ["Ahmedabad", "France", "Belgium", "Dubai", "China"];
...
let guestsList: string[] = ["AMAN", "ASHWARYA", "JESSICA", "JASON"];
...
console.log(
  `We had finally invited ${guestsList.length} guests .`
);
...
let countriesName: string[] = ["AMERICA", "CANADA", "ITLAY", "CHINA", "TURKEY"];
console.log("list of countries:");
for (let top of countriesName) {
  console.log(top);
}

// QUESTION NO 21 SOLUTIOIN
// They think of something you could store in a typescript object.write a program that creats object
// containing these items.

interface item {
  name: string; // check by youtube
  price: number;
}
const book: item = {
...
let array: (string | number)[] = ["AMAN", "SHAHEEN", 7, 4, 2, "JOHNSON"]; // check by net
console.log(array[5]);
...
let users: string[] = ["sana", "hina", "aman", "eric", "admin"];
// printing message
...
let userNames: string[] = ["ameen", "ali", "sana", "waniya", "admin"];
...
let currentUsers: string[] = ["AshWerya", "SanjAna", "Ruhi", "RaMan", "John"];
let newUsers: string[] = ["Bilal", "Raman", "william", "Jamas", "Ruhi"];
...
let pizzas: string[] = ["Pepperoni", "Chessy", "BBQ chicken"];
...
let magician: string[] = ["Domnic", "Thomas", "Herry", "Aleina"];
...
let magicians: string[] = ["Domnic", "Thomas", "Herry", "Aleina"];
...
let Information = storeCarInfo(
  "Toyota",
  "Civic",
  { color: "White" },
  { features: ["Navigation", "Automatic Gear"] }
);
